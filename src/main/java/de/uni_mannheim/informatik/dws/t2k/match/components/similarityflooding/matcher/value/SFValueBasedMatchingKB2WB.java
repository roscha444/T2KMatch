...
import de.uni_mannheim.informatik.dws.t2k.match.components.similarityflooding.matcher.value.kb2wb.ValueTypeComparatorKB2WB;
                ...
                for (String dbPediaClass : dbPediaClassesForTable) {
                    ...
                    if (kbTable != null && kbTable.size() > 0) {
                        ...
                        SimilarityFloodingAlgorithm<MatchableTableColumn, MatchableTableRow> sfMatcher = new SimilarityFloodingAlgorithm<>(kbTable, webTable,
                            new ValueTypeComparatorKB2WB(originalMatchableToAdaptedMatchable, tableToCorrespondenceMap, surfaceForms, kb), FixpointFormula.A);
